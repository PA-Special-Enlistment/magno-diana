...
Route::get('/editDesig/{id}', 'LibDesignationController@edit');
Route::get('/editType/{id}', 'LibEquipmentTypeController@edit');
...
Route::resource('designation', 'LibDesignationController');
Route::resource('type', 'LibEquipmentTypeController');
