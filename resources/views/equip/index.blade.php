                        ...
                        <ul class="navbar-nav ml-lg-auto">
                            <li class="nav-item">
                                ...
                                <a href="{{ url('/downloadEquipment') }}" role="button" class="btn btn-link text-default text-black" title="Extract CSV">  
                                    <i class="fa fa-user-plus fa-2x"><svg class="bi bi-arrow-down-square-fill" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
