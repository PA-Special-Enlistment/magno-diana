...
<head>
    ...
    <title>{{ config('Inventory System', 'Inventory System') }}</title>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary mt-1">
        <div class="container">
            <a class="navbar-brand" href="{{ url('/') }}">
                {{ config('Inventory System', 'Inventory System') }}
            </a>
                ...
                <div class="collapse navbar-collapse" id="navbar-primary">
                    ...
                    <ul class="navbar-nav ml-lg-auto color-black">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                            ...
                            @if(Auth::user()->isAdmin == 'Y')
                            <li class="nav-item">
                                <a class="dropdown-item" href="{{ url('/designation')}}">Designation
                                </a>
                            </li>
                            <div class="dropdown-divider"></div>
                            <li class="nav-item">
                                    <a class="dropdown-item" href="{{ url('/type')}}">Equipment Type
                                    </a>
                                </li>
                                <div class="dropdown-divider"></div>
                            @else
